...
namespace WebApplication.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<BusUser, long>(new UserStore<BusUser, BusRole, long, BusLogin, BusUserRole, BusClaim>(new ApplicationDbContext())))
        {
        }

        public AccountController(UserManager<BusUser, long> userManager)
        {
            UserManager = userManager;
        }

        public UserManager<BusUser, long> UserManager { get; private set; }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new BusUser() { UserName = model.UserName };
